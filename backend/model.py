...
PROMPTS = {
    ...
    "newspaper": "a photo of paper, newspaper, or magazine",
    "tin can": "a photo of a tin can or metal food can",
    "aluminium can": "a photo of an aluminium can or soda can",
    "food scraps": "a photo of food scraps, leftover food, fruit peels, vegetable waste, or compostable organic matter",
    "greasy pizza box": "a photo of a greasy pizza box or food-stained cardboard",
    "plastic bag": "a photo of a plastic bag or plastic film",
    "textiles": "a photo of clothing, fabric, or textiles",
    "styrofoam": "a photo of styrofoam or polystyrene packaging",
    ...
    "mirror": "a photo of a mirror or window glass",
    "general waste": "a photo of general household trash or garbage",
